...
export function StoreItem({ name, description, price, imageUrl, category }: StoreItemProps) {
  ...
  return (
    <div 
      className="group relative bg-[rgb(var(--bg-light))] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 flex flex-col h-full"
