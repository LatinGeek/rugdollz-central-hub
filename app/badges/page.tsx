...
type CollectionName = 'RugDollz OG' | 'RugDollz Social' | 'RugDollz 3D' | 'Doruzu' | 'Game NFTs'
...
const sampleBadges: Badge[] = [
    ...
    },
    {
      ...
      isActive: false,
      collection: 'Game NFTs'
    }
  ]

// Last 10 earned badges
const lastEarnedBadges: Badge[] = [
    {
        id: '7',
        name: 'Tournament Winner',
        description: 'Won a major RugDollz tournament event',
...
export default function BadgePage() {
  ...
  return (
    <div className="container mx-auto bg-[rgb(var(--bg-darker))] px-8 py-8">
      ...
      {selectedBadge && (
        <BadgeDetails
          badges={sampleBadges.filter((badge) => badge.collection === activeTab)}
